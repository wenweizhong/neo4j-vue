...
export default {
  ...
  data () {
    return {
      width: 800,
      height: 500,
      colorList:['red', 'blue','red', 'blue','red', 'blue','red', 'blue','red', 'blue','red', 'blue','red', 'blue'],
      testGraph:{
        "nodes": [
          {"id": "Myriel", "group": 1},
          {"id": "Napoleon", "group": 1},
  ...
  methods:{
    initGraph(data){
      ...
      const simulation = d3.forceSimulation(nodes)
         ...
         .force("charge", d3.forceManyBody().strength(-1000))//两个节点的距离
      ...
      const node = g.append("g")
       ...
       .on("click", _this.queryTest) //点击该点会调用函数
